...
namespace SirRandoo.ToolkitUtils.Helpers
{
    ...
    {
        private static readonly IRimLogger Logger = new RimThreadedLogger("tku.healer");
        ...
        public static void Resurrect(this Pawn pawn)
        {
            ...
            {
                Logger.Warn("Failed to revive with side effects -- falling back to a regular revive");
        ...
        public static bool TryResurrect([NotNull] this Pawn pawn)
        {
            try
            {
                ...
                {
                    Logger.Warn($"Could not drop {pawn} at {val.Position.ToString()} from {val.LabelShort}");
            ...
            {
                Logger.Error($"Could not revive {pawn.LabelShort}", e);
