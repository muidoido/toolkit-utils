...
namespace SirRandoo.ToolkitUtils
{
    public static class Paths
    {
        ...
        public static readonly string RevenuePath = Path.Combine(SaveHelper.dataPath, "revenue.dat");
        public static readonly string TraitFilePath = Path.Combine(SaveHelper.dataPath, "traits.json");
        public static readonly string ConfigStorePath = Path.Combine(SaveHelper.dataPath, "config.json");
