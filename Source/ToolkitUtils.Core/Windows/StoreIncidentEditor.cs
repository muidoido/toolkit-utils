...
namespace SirRandoo.ToolkitUtils.Windows
{
    public class StoreIncidentEditor : TwitchToolkit.Windows.StoreIncidentEditor
    {
        ...
        {
            (Rect abbrLabel, Rect abbrField) = listing.Split(0.6f);
            ...
            {
                (Rect costLabel, Rect costField) = listing.Split(0.6f);

                listing.Gap();
                Widgets.Label(costLabel, _priceText);
                UiHelper.IntEntry(costField, ref storeIncident.cost);
            ...
            {
                (Rect timesLabel, Rect timesField) = listing.Split(0.6f);
            ...
            if (storeIncidentVariables?.maxWager > 0)
            {
                ...
                UiHelper.IntEntry(wagerField, ref storeIncidentVariables.maxWager);
