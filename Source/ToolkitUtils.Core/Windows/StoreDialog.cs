        ...
        private void GenerateFilters()
        {
            _filterManager.RegisterFilter(
                ...
                new ThingItemFilter
                {
                    ...
                    Label = "TKUtils.StoreFilters.Researched".TranslateSimple().CapitalizeFirst()
                }
            );
            ...
            _filterManager.RegisterFilter(
                ...
                new ThingItemFilter
                {
                    ...
                    Label = "TKUtils.StoreFilters.NotResearched".TranslateSimple().CapitalizeFirst()
                }
            );
            ...
            _filterManager.RegisterFilter(
                ...
                new ThingItemFilter
                {
                    ...
                    Label = "TKUtils.StoreFilters.Manufactured".TranslateSimple().CapitalizeFirst()
                }
            );
            ...
            _filterManager.RegisterFilter(
                ...
                new ThingItemFilter
                {
                    ...
                    Label = "TKUtils.StoreFilters.NonManufactured".TranslateSimple().CapitalizeFirst()
                }
            );
            ...
            _filterManager.RegisterFilter(
                ...
                new ThingItemFilter
                {
                    ...
                    Label = "TKUtils.StoreFilters.Stackable".TranslateSimple().CapitalizeFirst()
                }
            );
            ...
            _filterManager.RegisterFilter(
                ...
                new ThingItemFilter
                {
                    ...
                    Label = "TKUtils.StoreFilters.Stuff".TranslateSimple().CapitalizeFirst()
                }
            );
            ...
            _filterManager.RegisterFilter(
                ...
                new ThingItemFilter
                {
                    ...
                    Label = "TKUtils.StoreFilters.NotStuff".TranslateSimple()
                }
            );
            ...
            _filterManager.RegisterFilter(
                ...
                new ThingItemFilter
                {
                    ...
                    Label = "TKUtils.StoreFilters.NonStackable".TranslateSimple().CapitalizeFirst()
                }
            );
            ...
            _filterManager.RegisterFilter(
                ...
                new ThingItemFilter
                {
                    ...
                    Label = "TKUtils.StoreFilters.Disabled".TranslateSimple().CapitalizeFirst()
                }
            );
            ...
            _filterManager.RegisterFilter(
                ...
                new ThingItemFilter
                {
                    ...
                    Label = "TKUtils.StoreFilters.Enabled".TranslateSimple().CapitalizeFirst()
                }
            );
