...
namespace SirRandoo.ToolkitUtils.Utils
{
    ...
    public class NameConstraint : ConstraintBase
    {
        ...
        public NameConstraint()
        {
            ...
            _nameStrategyButtonText = $"TKUtils.PurgeMenu.{nameof(NameStrategies.Is)}".TranslateSimple();

            _strategyOptions = Enum.GetNames(typeof(NameStrategies))
               .Select(t => new FloatMenuOption($"TKUtils.PurgeMenu.{t}".TranslateSimple(), () => NameStrategy = (NameStrategies)Enum.Parse(typeof(NameStrategies), t)))
               .ToList();
        }
        ...
        public NameStrategies NameStrategy
        {
            ...
            set
            {
                if (_nameStrategy != value)
                {
                    ...
                    _nameStrategyButtonText = $"TKUtils.PurgeMenu.{_nameStrategyText}".TranslateSimple();
                }
