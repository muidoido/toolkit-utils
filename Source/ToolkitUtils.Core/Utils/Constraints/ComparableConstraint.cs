...
namespace SirRandoo.ToolkitUtils.Utils
{
    public class ComparableConstraint : ConstraintBase
    {
        ...
        protected ComparableConstraint()
        {
            ...
            _comparisonOptions = Data.ComparisonTypes.Select(t => new FloatMenuOption($"TKUtils.PurgeMenu.{t.ToString()}".TranslateSimple(), () => Comparison = t)).ToList();
        }
        ...
        protected ComparisonType Comparison
        {
            ...
            private set
            {
                ...
                {
                    _comparisonText = Enum.GetName(typeof(ComparisonType), value);
                    _comparisonButtonText = $"TKUtils.PurgeMenu.{_comparisonText}".TranslateSimple();
                }
