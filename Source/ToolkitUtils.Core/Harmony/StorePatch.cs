...
namespace SirRandoo.ToolkitUtils.Harmony
{
    ...
    public static class StorePatch
    {
        ...
        private static void DrawUtilsContents([CanBeNull] Listing_Standard optionsListing)
        {
            ...
            if (optionsListing.ButtonTextLabeled($"[ToolkitUtils.Core] {"Traits".TranslateSimple()}", openText))
            {
            ...
            if (optionsListing.ButtonTextLabeled($"[ToolkitUtils.Core] {"Race".TranslateSimple().Pluralize()}", openText))
            {
            ...
            if (optionsListing.ButtonTextLabeled($"[ToolkitUtils.Core] {"TKUtils.Editor.Title".TranslateSimple()}", openText))
            {
