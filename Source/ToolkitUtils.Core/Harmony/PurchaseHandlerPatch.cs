...
namespace SirRandoo.ToolkitUtils.Harmony
{
    ...
    public static class PurchaseHandlerPatch
    {
        ...
        public static bool ResolvePurchasePrefix(Viewer viewer, [NotNull] ITwitchMessage twitchMessage, bool separateChannel = false)
        {
        ...
        public static bool ResolvePurchaseSimplePrefix([NotNull] Viewer viewer, ITwitchMessage twitchMessage, StoreIncidentSimple incident, string formattedMessage)
        {
            ...
            if (!inc.IsPossible())
            {
                MessageHelper.ReplyToUser(viewer.username, "TwitchToolkitEventNotPossible".TranslateSimple());
            ...
            TwitchWrapper.SendChatMessage(Helper.ReplacePlaceholder("TwitchToolkitEventPurchaseConfirm".TranslateSimple(), viewer: viewer.username, first: incident.label.CapitalizeFirst()));
        ...
        public static bool ResolvePurchaseVariablesPrefix([NotNull] Viewer viewer, ITwitchMessage twitchMessage, StoreIncidentVariables incident, string formattedMessage)
        {
        ...
        public static bool CheckIfViewerIsInVariableCommandListPrefix([NotNull] string username, ref bool __result)
        {
            ...
            __result = true;
            MessageHelper.ReplyToUser(username, "TKUtils.PausedExtended".Translate(CommandDefOf.UnstickMe.command));
